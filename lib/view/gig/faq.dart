...
import 'package:freibr/view/gig/question.dart';
import 'package:get/get.dart';
import 'package:provider/provider.dart';
import 'package:collection/collection.dart';

class GigFaq extends StatelessWidget {
  GigFaq({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StatefulWrapper(
      ...
      child: Scaffold(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text("Add Faq", style: Get.theme.textTheme.bodyText1),
                    InkWell(
                        onTap: () {
                          showQuestionDialog(
                ...
                gigController.gig?.faqs != null
                    ? Column(
                        children: gigController.gig.faqs
                            ?.mapIndexed(
                              ((index, e) => Card(
                                    child: ExpansionTile(
                                      trailing: IconButton(
                                        ...
                                        onPressed: () {
                                          gigController.removeGigFaq(index, e);
                                        },
                                      ),
                                      title: Text(
                                        e.title,
        ...
        bottomNavigationBar: gigController.gig.faqs.length > 0
            ? Container(
