...
class Following extends StatelessWidget {
  const Following({Key key, this.user}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    void getFollowers({bool isRefresh = false}) {
      controller.getPagedFollowings(controller.followingPagingController.page,
          pageSize, user.id.toString(),
          isRefresh: isRefresh);
    }
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: SmartRefresher(
            ...
            controller: controller.followingPagingController.refreshController,
            onRefresh: () {
              controller.followingPagingController.clearItems();
              getFollowers(isRefresh: true);
            },
            onLoading: () {
              getFollowers();
            },
            child: !controller.followingPagingController.hasData &&
                ...
                : controller.isLoading &&
                        !controller.followingPagingController.hasData
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (c, index) {
                          if (controller
                                  .followingPagingController.items.length >
                              0) {
                            var item = controller
                                .followingPagingController.items[index];
                            ...
                            return item.following != null &&
                                ...
                                ? FRListTileButton(
                                    ...
                                    onButtonTap: () async {
                                      ...
                                      controller.followingPagingController
                                          .items[index].following = result;
                                    },
                                    user: item.following)
                                : Container();
                          }
                        ...
                        itemCount:
                            controller.followingPagingController.items.length,
                      ),
          ),
        ),
      ),
